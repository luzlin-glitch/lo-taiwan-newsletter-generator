...
def generate_newsletter_html(month, main_theme, editor, sections, visual_theme, layout_style):
...
if st.session_state.sections:
    ...
    try:
        ...
        st.download_button(
            ...
            data=pdf_bytes,
            file_name=f"LO_Taiwan_Monthly_Pulse_{newsletter_month.replace(' ', '_')}_{visual_theme}_{layout_style}.pdf",
